...
- **Long context costs speed.** Decode fell to 18.0 tok/s at about 28K context during the task suite, from 57.7 at short context. [task suite](docs/log/2026-09-07-task-suite-baseline.md)
...
- Map the decode curve against context length. It is 57.7 tok/s short and 18.0 at 28K, and nobody has measured the shape in between or what it does near 96K. This decides whether the full window is comfortable to work in or merely available.
