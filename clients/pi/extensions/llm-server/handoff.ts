// Copied from pi's examples/extensions/handoff.ts (MIT) at 0.85.1. Hands a focused prompt to a
// new session instead of compacting. The new session is a few thousand tokens, so its first
// request prefills in a second or two rather than the 12 s a post-compaction request costs.
