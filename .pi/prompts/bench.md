...
---
Benchmark the running server with `./scripts/bench.py --base-url http://vllm:8000 --key "$LLM_SERVER_API_KEY" --corpus code --gen 128 -n 3` for each prompt size in: ${1:-512 8192 32768}
